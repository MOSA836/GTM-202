...
- **k-sheeted covered of connected sum**: A proof of the k-sheeted covering of the connected sum $M \sharp N$ by a manifold of the form $\widetilde{M} \mathbin{\#} N \mathbin{\#} \cdots \mathbin{\#} N$, utilizing the ball to be cut out of $M$ to lie inside an evenly covered neighborhood.
